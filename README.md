...
```
usage: Main [-h] [--gravity GRAVITY] [--scale SCALE] [--theta THETA] [--tolerance TOLERANCE] [--linlog {true,false}] [--weightinfluence WEIGHTINFLUENCE]
            [--stronggravity {true,false}] [--threads THREADS] [--duration DURATION] [--proportion PROPORTION] [-O OUTDIR] input_file
